    ...
    suite("codecs")(
      suite("numeric")(
        ...
        test("float4") {
          ...
          buf.clear; float4(Float.MinPositiveValue); assertTrue(Float.MinPositiveValue == float4())
        ...
        test("float8") {
          ...
          buf.clear; float8(Double.MinPositiveValue); assertTrue(Double.MinPositiveValue == float8())
        },
        test("numeric") {
      ...
      suite("text")(
        test("text") {
          ...
          buf.clear; text("-1.0"); assertTrue("-1.0" == text())
      ...
      suite("timestamps")(
        test("interval") {
          ...
          buf.clear; i = Interval(1685, 3, 31, 10, 59, 59.999); interval(i); assertTrue(i == interval())
        },
        test("timestamptz") {
          ...
          buf.clear; t = OffsetDateTime.of(LocalDate.of(1685, 3, 31), LocalTime.of(10, 59), UTC); timestamptz(t);
          assertTrue(t == timestamptz())
        } @@ TestAspect.nonFlaky,
        test("date") {
          import java.time.LocalDate
          given buf: ByteBuf = Unpooled.wrappedBuffer(Array.ofDim[Byte](2048))
          buf.clear; var d = LocalDate.of(1685, 3, 31); date(d); assertTrue(d == date())
